  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="hidden lg:flex h-screen overflow-hidden">
        {!sidebarCollapsed && (
          <div className="w-64 flex-shrink-0 bg-primary-500 h-screen overflow-y-auto">
            <Sidebar onClose={() => setSidebarCollapsed(true)} currentPage="subAdminSettings" />
          </div>
        )}
        ...
        <div className={`flex-1 flex flex-col h-screen overflow-hidden bg-gray-50 ${sidebarCollapsed ? 'w-full' : ''}`}>
          ...
          <main className="flex-1 overflow-y-auto overflow-x-hidden p-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">Sub Admin - Settings page content will go here</p>
            </div>
          </main>
        </div>
      </div>
      ...
      <div className="lg:hidden">
        ...
        `}>
          <Sidebar onClose={() => setSidebarOpen(false)} currentPage="subAdminSettings" />
        </div>
