                ...
                <div className="flex items-start justify-between px-6 py-6 border-b border-gray-200">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      onClick={onSave}
                      disabled={saving}
                      className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-primary-500 text-white hover:bg-primary-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
                    >
                      {saving ? <ButtonLoader size="sm" /> : <Save size={18} />}
