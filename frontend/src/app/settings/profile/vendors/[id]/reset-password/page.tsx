          ...
          <main className="flex-1 overflow-y-auto p-4 sm:p-6">
            ...
            <div className="w-full">
              <div className="bg-white rounded-lg shadow-sm p-6 sm:p-8">
                <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 sm:mb-6">Reset Password</h2>
                ...
                <div className="mt-6 sm:mt-8 flex justify-end">
                  <button
                    ...
                    disabled={isChanging}
                    className={`px-6 py-2.5 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium w-full sm:w-auto ${
